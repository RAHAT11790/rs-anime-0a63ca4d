      ...
      <div className="flex items-center gap-2.5 mb-5">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full py-3 pl-11 pr-4 rounded-xl bg-card border border-foreground/10 text-foreground text-[15px] focus:outline-none focus:border-primary focus:shadow-[0_0_20px_hsla(270,70%,55%,0.4)] placeholder:text-muted-foreground"
            autoFocus
          />
        </div>
      </div>
